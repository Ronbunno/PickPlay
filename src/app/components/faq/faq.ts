...
export class Faq {
  ...
  faqs = [
    ...
    },
    {
      ...
      answer: `Developers can email <a href="mailto:developers@pickplay.com" class="text-blue-600 hover:underline">developerspickplay.com</a> to update assets or information.`,
      isOpen: false
    },
    {
